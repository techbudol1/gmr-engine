...
func New(cfg config.Config, engineStore store.Store) *fiber.App {
	...
	dashboard.Get("/projects/:id/contracts/marketplaces", server.requireAccount, server.dashboardMarketplaceDeployments)
	dashboard.Post("/projects/:id/contracts/marketplaces", server.requireAccount, server.dashboardCreateMarketplaceDeployment)
	dashboard.Delete("/contracts/marketplaces/:id", server.requireAccount, server.dashboardDeleteMarketplaceDeployment)
	...
	dashboard.Get("/projects/:id/contracts/privacy-access-passes", server.requireAccount, server.dashboardPrivacyAccessPassDeployments)
	dashboard.Post("/projects/:id/contracts/privacy-access-passes", server.requireAccount, server.dashboardCreatePrivacyAccessPassDeployment)
	dashboard.Delete("/contracts/privacy-access-passes/:id", server.requireAccount, server.dashboardDeletePrivacyAccessPassDeployment)
	...
	v1.Get("/wallets/transactions", server.requireScope("wallets:read"), server.walletTransactions)
	...
	v1.Get("/native/balance", server.requireScope("wallets:read"), server.nativeTokenBalance)
	...
	v1.Get("/solana/native/balance", server.requireScope("wallets:read"), server.solanaNativeBalance)
	v1.Get("/solana/spl/balance", server.requireScope("wallets:read"), server.solanaSPLBalance)
	v1.Get("/solana/spl/balances", server.requireScope("wallets:read"), server.solanaSPLBalances)
	v1.Get("/solana/wallets/transactions", server.requireScope("wallets:read"), server.solanaWalletTransactions)
	v1.Get("/solana/accounts/:address", server.requireScope("contracts:read"), server.solanaAccount)
	v1.Get("/solana/blockhash/latest", server.requireScope("transactions:read"), server.solanaLatestBlockhash)
	v1.Post("/solana/transactions/simulate", server.requireScope("transactions:write"), server.solanaSimulateTransaction)
	v1.Post("/solana/transactions/send", server.requireScope("transactions:write"), server.solanaSendTransaction)
	...
	v1.Post("/contracts/marketplaces/deployments", server.requireScope("contracts:write"), server.createMarketplaceDeployment)
	...
	v1.Post("/contracts/privacy-access-passes/deployments", server.requireScope("contracts:write"), server.createPrivacyAccessPassDeployment)
